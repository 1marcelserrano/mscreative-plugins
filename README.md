...
| [`full-page-capture`](./plugins/full-page-capture/) | v0.1.2 | Fotografa a página inteira num PNG, inclusive quando quem rola é um painel interno. Cabeçalho fixo aparece uma vez, carregamento preguiçoso não deixa buraco. | Extensão Chrome (MV3) |
